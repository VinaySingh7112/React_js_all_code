        ...
        <Navbar className='position-fixed d-flex justify-content-between pe-3 ps-5 pt-2 pb-1 w-100 z-3' style={{ backgroundColor: "#dc4c3e", height:'45px' }}>
            ...
            <div className='d-flex pt-2'style={{paddingInlineStart:'0px'}}>
                <ul style={{paddingInlineStart:'0px'}}>
                    ...
                    <NavLink to='/items' className='navbar-brand text-decoration-none text-light  align-items-center'>Items</NavLink>
                    <NavLink to='/view' className='navbar-brand text-decoration-none text-light  align-items-center'> View</NavLink>
                </ul>
