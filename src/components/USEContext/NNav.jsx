...
function NNav() {
    ...
    // }
    return (
        <Navbar className='position-fixed d-flex justify-content-between pe-3 ps-5 pt-2 pb-1 w-100 z-3' style={{ backgroundColor: "#dc4c3e", height:'45px',top:"0" }}>
            <div className='pb-1'>
            ...
            <div className='d-flex pt-2'style={{paddingInlineStart:'0px'}}>
                ...
                <span className="bi bi-person-circle text-light  navbar-brand"></span>
                 <span  className="bi bi-arrow-left-short text-light  navbar-brand"></span>
